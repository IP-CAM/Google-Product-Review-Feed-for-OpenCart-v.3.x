...
Thank you for your interest in contributing to the Playful Sparkle Product Review Feed extension! We value contributions from the community to enhance this project for all users. Whether you're fixing bugs, adding features, improving documentation, or translating the extension, your efforts are greatly appreciated.
...
- Knowledge of XML and JSON formats (for feed-related contributions)
- Understanding of product review data structures and formats
...
1. Review the [existing issues](https://github.com/playfulsparkle/oc3_product_review_feed/issues) to avoid duplicates.
...
- Validate edge cases, such as different review feed configurations or large datasets.
- Confirm that your changes do not conflict with core OpenCart functionality.
- Verify that the generated product review feed is valid and adheres to the required specifications (e.g., Google Merchant Center, Facebook, etc.).
...
- [GitHub Issues](https://github.com/playfulsparkle/oc3_product_review_feed/issues)
