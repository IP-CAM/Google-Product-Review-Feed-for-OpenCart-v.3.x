...
class ControllerExtensionFeedPsProductReviewFeed extends Controller
{
     ...
     */
    const EXTENSION_DOC = 'https://github.com/playfulsparkle/oc3_product_review_feed.git';
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('feed_ps_product_review_feed', $this->request->post, $this->request->get['store_id']);
    ...
    public function install()
    {
        ...
        $data = array(
            'feed_ps_product_review_feed_max_product_images' => 1,
        );
