...
$_['text_getting_started']         = '<p><strong>Übersicht:</strong> Die Google Product Review Feed Erweiterung für OpenCart 3.x ermöglicht es Shop-Betreibern, Produktbewertungen zu exportieren und direkt an ihr Google Merchant Center zu übermitteln. Diese Integration ermöglicht es Google, Ihre von Kunden erstellten Bewertungen neben Ihren Produkten in Google Shopping und anderen Google-Diensten anzuzeigen. Die Erweiterung bietet auch optionale Opt-in- und Badge-Integrationen, mit denen Sie Feedback nach dem Kauf über Google-Umfragen sammeln und Ihr Händlerbewertungs-Badge auf Ihrer Storefront anzeigen können.</p><p><strong>Anforderungen:</strong> OpenCart 3.x+, PHP 7.3 oder höher, und Zugriff auf Ihr <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> mit aktiviertem Product Ratings-Programm.</p>';
$_['text_setup']                   = '<p><strong>Installation und Einrichtung:</strong></p><ul><li><strong>Schritt 1:</strong> Laden Sie die Erweiterung über den OpenCart Erweiterungs-Installer hoch.</li><li><strong>Schritt 2:</strong> Nach der Installation gehen Sie zu <strong>Erweiterungen</strong> -&gt; <strong>Modifikationen</strong> und klicken Sie auf den Button <strong>Aktualisieren</strong>, um den Modifikations-Cache zu aktualisieren.</li><li><strong>Schritt 3:</strong> Navigieren Sie zu <strong>Erweiterungen</strong> -&gt; <strong>Feeds</strong>.</li><li><strong>Schritt 4:</strong> Suchen Sie <strong>Playful Sparkle - Google Product Review Feed</strong> in der Liste und klicken Sie auf <strong>Bearbeiten</strong>.</li><li><strong>Schritt 5:</strong> Geben Sie Ihre <strong>Google Merchant Center ID</strong> ein.</li><li><strong>Schritt 6:</strong> Aktivieren Sie die <strong>Opt-in Integration</strong>, um Google zu erlauben, nach dem Checkout eine Umfrage anzuzeigen.</li><li><strong>Schritt 7:</strong> Aktivieren Sie die <strong>Badge Integration</strong>, um das Google Customer Reviews-Badge auf Ihrer Website anzuzeigen.</li><li><strong>Schritt 8:</strong> Optional können Sie einen <strong>Benutzernamen</strong> und ein <strong>Passwort</strong> festlegen, um den Zugriff auf die Bewertungsfeed-URL zu schützen.</li><li><strong>Schritt 9:</strong> Speichern Sie Ihre Einstellungen.</li></ul>';
$_['text_troubleshot']             = '<ul><li><strong>Feed wird nicht angezeigt:</strong> Stellen Sie sicher, dass die Erweiterung aktiviert und korrekt konfiguriert ist und die Feed-URL zugänglich ist.</li><li><strong>Keine Bewertungen erscheinen im Feed:</strong> Bestätigen Sie, dass Ihr Shop genehmigte Produktbewertungen in OpenCart hat.</li><li><strong>Opt-in oder Badge nicht sichtbar:</strong> Überprüfen Sie, ob die relevante Integration aktiviert ist, Ihre Merchant ID gültig ist und der OpenCart Modifikations-Cache nach der Installation aktualisiert wurde.</li><li><strong>Opt-in oder Badge zeigt 404 Fehler:</strong> Stellen Sie sicher, dass die Erweiterung auf einer öffentlich zugänglichen Domain mit einem gültigen HTTPS-Zertifikat installiert ist. Google-Dienste können nicht auf lokale, Intranet- oder unsichere Domains zugreifen.</li><li><strong>Feed-Zugriff blockiert:</strong> Wenn der Feed-Schutz aktiviert ist, stellen Sie sicher, dass der korrekte Benutzername und das Passwort beim Zugriff auf die Feed-URL angegeben werden.</li></ul>';
