...
$_['text_getting_started']     = '<p><strong>Visión General:</strong> La extensión Google Product Review Feed para OpenCart 3.x permite a los propietarios de tiendas exportar y enviar reseñas de productos directamente a su Google Merchant Center. Esta integración permite a Google mostrar las reseñas generadas por sus clientes junto a sus productos en Google Shopping y otros servicios de Google. La extensión también ofrece integraciones opcionales de Opt-in y Badge, que le permiten recopilar feedback post-compra a través de Google surveys y mostrar la insignia de su calificación de vendedor en su tienda.</p><p><strong>Requisitos:</strong> OpenCart 3.x o superior, PHP 7.3 o superior, y acceso a su <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> con el programa Product Ratings habilitado.</p>';
$_['text_setup']               = '<p><strong>Instalación y Configuración:</strong></p><ul><li><strong>Paso 1:</strong> Suba la extensión usando el instalador de extensiones de OpenCart.</li><li><strong>Paso 2:</strong> Después de la instalación, vaya a <strong>Extensiones</strong> -> <strong>Modificaciones</strong> y haga clic en el botón <strong>Refrescar</strong> para actualizar el caché de modificaciones.</li><li><strong>Paso 3:</strong> Navegue a <strong>Extensiones</strong> -> <strong>Feeds</strong>.</li><li><strong>Paso 4:</strong> Localice <strong>Playful Sparkle - Google Product Review Feed</strong> en la lista y haga clic en <strong>Editar</strong>.</li><li><strong>Paso 5:</strong> Introduzca su <strong>Google Merchant Center ID</strong>.</li><li><strong>Paso 6:</strong> Habilite la <strong>Opt-in Integration</strong> para permitir que Google muestre una encuesta después de la compra.</li><li><strong>Paso 7:</strong> Habilite la <strong>Badge Integration</strong> para mostrar la insignia de Google Customer Reviews en su sitio.</li><li><strong>Paso 8:</strong> Opcionalmente, establezca un <strong>nombre de usuario</strong> y una <strong>contraseña</strong> para proteger el acceso a la URL del feed de reseñas.</li><li><strong>Paso 9:</strong> Guarde su configuración.</li></ul>';
$_['text_troubleshot']         = '<ul><li><strong>El feed no se muestra:</strong> Asegúrese de que la extensión esté habilitada, configurada correctamente y que la URL del feed sea accesible.</li><li><strong>No aparecen reseñas en el feed:</strong> Confirme que su tienda tiene reseñas de productos aprobadas en OpenCart.</li><li><strong>Opt-in o Badge no visibles:</strong> Verifique que la integración relevante esté habilitada, que su Merchant ID sea válido y que el caché de modificaciones de OpenCart se haya actualizado después de la instalación.</li><li><strong>Opt-in o Badge muestran error 404:</strong> Asegúrese de que la extensión esté instalada en un dominio de acceso público con un certificado HTTPS válido. Los servicios de Google no pueden acceder a dominios locales, de intranet o no seguros.</li><li><strong>Acceso al feed bloqueado:</strong> Si la protección del feed está habilitada, asegúrese de proporcionar el nombre de usuario y la contraseña correctos al acceder a la URL del feed.</li></ul>';
