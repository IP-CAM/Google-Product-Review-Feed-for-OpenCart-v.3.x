...
$_['text_getting_started']       = '<p><strong>Przegląd:</strong> Rozszerzenie Google Product Review Feed dla OpenCart 3.x umożliwia właścicielom sklepów eksportowanie i przesyłanie opinii o produktach bezpośrednio do Google Merchant Center. Ta integracja pozwala Google wyświetlać opinie generowane przez klientów obok Twoich produktów w Google Shopping i innych usługach Google. Rozszerzenie oferuje również opcjonalne integracje Opt-in i Odznaki, które pozwalają zbierać opinie po zakupie za pomocą ankiet Google i wyświetlać odznakę oceny sprzedawcy w witrynie sklepu.</p><p><strong>Wymagania:</strong> OpenCart 3.x+, PHP 7.3 lub nowszy, oraz dostęp do Twojego <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> z włączonym programem Ocen produktów.</p>';
$_['text_setup']                 = '<p><strong>Instalacja i konfiguracja:</strong></p><ul><li><strong>Krok 1:</strong> Prześlij rozszerzenie za pomocą Instalatora Rozszerzeń OpenCart.</li><li><strong>Krok 2:</strong> Po instalacji przejdź do <strong>Rozszerzenia</strong> -&gt; <strong>Modyfikacje</strong> i kliknij przycisk <strong>Odśwież</strong>, aby zaktualizować pamięć podręczną modyfikacji.</li><li><strong>Krok 3:</strong> Przejdź do <strong>Rozszerzenia</strong> -&gt; <strong>Kanały danych</strong>.</li><li><strong>Krok 4:</strong> Znajdź <strong>Playful Sparkle - Google Product Review Feed</strong> na liście i kliknij <strong>Edytuj</strong>.</li><li><strong>Krok 5:</strong> Wprowadź swój <strong>identyfikator Google Merchant Center</strong>.</li><li><strong>Krok 6:</strong> Włącz <strong>Integrację Opt-in</strong>, aby umożliwić Google wyświetlanie ankiety po zakończeniu realizacji zamówienia.</li><li><strong>Krok 7:</strong> Włącz <strong>Integrację Odznaki</strong>, aby wyświetlać odznakę Ocen klientów Google w swojej witrynie.</li><li><strong>Krok 8:</strong> Opcjonalnie ustaw <strong>nazwę użytkownika</strong> i <strong>hasło</strong>, aby chronić dostęp do adresu URL kanału opinii.</li><li><strong>Krok 9:</strong> Zapisz ustawienia.</li></ul>';
$_['text_troubleshot']           = '<ul><li><strong>Kanał nie wyświetla się:</strong> Upewnij się, że rozszerzenie jest włączone, poprawnie skonfigurowane, a adres URL kanału jest dostępny.</li><li><strong>W kanale nie pojawiają się opinie:</strong> Upewnij się, że Twój sklep ma zatwierdzone opinie o produktach w OpenCart.</li><li><strong>Opt-in lub Odznaka nie są widoczne:</strong> Sprawdź, czy odpowiednia integracja jest włączona, Twój identyfikator Merchant ID jest prawidłowy, a pamięć podręczna modyfikacji OpenCart została odświeżona po instalacji.</li><li><strong>Opt-in lub Odznaka pokazuje błąd 404:</strong> Upewnij się, że rozszerzenie jest zainstalowane na publicznie dostępnej domenie z ważnym certyfikatem HTTPS. Usługi Google nie mają dostępu do domen lokalnych, w intranecie lub niezabezpieczonych.</li><li><strong>Dostęp do kanału zablokowany:</strong> Jeśli ochrona kanału jest włączona, upewnij się, że podczas uzyskiwania dostępu do adresu URL kanału podano prawidłową nazwę użytkownika i hasło.</li></ul>';
