...
$_['text_getting_started']       = '<p><strong>Panoramica:</strong> L\'estensione Google Product Review Feed per OpenCart 3.x consente ai proprietari dei negozi di esportare e inviare le recensioni dei prodotti direttamente al loro Google Merchant Center. Questa integrazione permette a Google di visualizzare le recensioni generate dai tuoi clienti accanto ai tuoi prodotti in Google Shopping e in altri servizi Google. L\'estensione offre anche integrazioni opzionali di Opt-in e Badge, che ti consentono di raccogliere feedback post-acquisto tramite sondaggi Google e di mostrare il badge del tuo punteggio venditore sul tuo negozio online.</p><p><strong>Requisiti:</strong> OpenCart 3.x+, PHP 7.3 o superiore, e accesso al tuo <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> con il programma Valutazioni dei prodotti abilitato.</p>';
$_['text_setup']                 = '<p><strong>Installazione e Configurazione:</strong></p><ul><li><strong>Passaggio 1:</strong> Carica l\'estensione utilizzando l\'Installer Estensioni di OpenCart.</li><li><strong>Passaggio 2:</strong> Dopo l\'installazione, vai su <strong>Estensioni</strong> -&gt; <strong>Modifiche</strong> e clicca sul pulsante <strong>Aggiorna</strong> per aggiornare la cache delle modifiche.</li><li><strong>Passaggio 3:</strong> Naviga su <strong>Estensioni</strong> -&gt; <strong>Feed</strong>.</li><li><strong>Passaggio 4:</strong> Individua <strong>Playful Sparkle - Google Product Review Feed</strong> nell\'elenco e clicca su <strong>Modifica</strong>.</li><li><strong>Passaggio 5:</strong> Inserisci il tuo <strong>ID Google Merchant Center</strong>.</li><li><strong>Passaggio 6:</strong> Abilita l\'<strong>Integrazione Opt-in</strong> per consentire a Google di mostrare un sondaggio dopo il checkout.</li><li><strong>Passaggio 7:</strong> Abilita l\'<strong>Integrazione Badge</strong> per mostrare il badge Google Customer Reviews sul tuo sito.</li><li><strong>Passaggio 8:</strong> Opzionalmente, imposta un <strong>nome utente</strong> e una <strong>password</strong> per proteggere l\'accesso all\'URL del feed delle recensioni.</li><li><strong>Passaggio 9:</strong> Salva le impostazioni.</li></ul>';
$_['text_troubleshot']           = '<ul><li><strong>Feed non visualizzato:</strong> Assicurati che l\'estensione sia abilitata, configurata correttamente e che l\'URL del feed sia accessibile.</li><li><strong>Nessuna recensione appare nel feed:</strong> Conferma che il tuo negozio abbia recensioni di prodotti approvate in OpenCart.</li><li><strong>Opt-in o Badge non visibile:</strong> Verifica che l\'integrazione pertinente sia abilitata, che il tuo ID Commerciante sia valido e che la cache delle modifiche di OpenCart sia stata aggiornata dopo l\'installazione.</li><li><strong>Opt-in o Badge mostra errore 404:</strong> Assicurati che l\'estensione sia installata su un dominio pubblicamente accessibile con un certificato HTTPS valido. I servizi Google non possono accedere a domini locali, intranet o non sicuri.</li><li><strong>Accesso al feed bloccato:</strong> Se la protezione del feed è abilitata, assicurati che vengano forniti il nome utente e la password corretti quando si accede all\'URL del feed.</li></ul>';
