...
$_['text_getting_started']         = '<p><strong>Genel Bakış:</strong> OpenCart 3.x için Google Product Review Feed eklentisi, mağaza sahiplerinin ürün incelemelerini doğrudan Google Merchant Center hesaplarına aktarmalarını ve göndermelerini sağlar. Bu entegrasyon, Google\'ın müşteri tarafından oluşturulan yorumlarınızı Google Shopping ve diğer Google hizmetlerinde ürünlerinizin yanında göstermesine olanak tanır. Eklenti ayrıca, isteğe bağlı Opt-in ve Badge entegrasyonları sunarak, satış sonrası geri bildirimleri Google anketleri aracılığıyla toplamanıza ve satıcı puanı rozetinizi mağazanızda sergilemenize olanak tanır.</p><p><strong>Gereksinimler:</strong> OpenCart 3.x+, PHP 7.3 veya üstü ve Ürün Puanları programının etkin olduğu <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> hesabınıza erişim.</p>';
$_['text_setup']                   = '<p><strong>Kurulum ve Ayarlar:</strong></p><ul><li><strong>Adım 1:</strong> Eklentiyi OpenCart Eklenti Yükleyicisi\'ni kullanarak yükleyin.</li><li><strong>Adım 2:</strong> Kurulumdan sonra, <strong>Eklentiler</strong> -&gt; <strong>Modifikasyonlar</strong> bölümüne gidin ve modifikasyon önbelleğini güncellemek için <strong>Yenile</strong> düğmesine tıklayın.</li><li><strong>Adım 3:</strong> <strong>Eklentiler</strong> -&gt; <strong>Beslemeler</strong> bölümüne gidin.</li><li><strong>Adım 4:</strong> Listede <strong>Playful Sparkle - Google Product Review Feed</strong>\'i bulun ve <strong>Düzenle</strong>\'ye tıklayın.</li><li><strong>Adım 5:</strong> <strong>Google Merchant Center ID</strong>\'nizi girin.</li><li><strong>Adım 6:</strong> Google\'ın ödeme sonrası anket göstermesine izin vermek için <strong>Opt-in Integration</strong>\'ı etkinleştirin.</li><li><strong>Adım 7:</strong> Sitenizde Google Customer Reviews rozetini göstermek için <strong>Badge Integration</strong>\'ı etkinleştirin.</li><li><strong>Adım 8:</strong> İsteğe bağlı olarak, inceleme beslemesi URL\'sine erişimi korumak için bir <strong>kullanıcı adı</strong> ve <strong>şifre</strong> belirleyin.</li><li><strong>Adım 9:</strong> Ayarlarınızı kaydedin.</li></ul>';
$_['text_troubleshot']             = '<ul><li><strong>Besleme görüntülenmiyor:</strong> Eklentinin etkinleştirildiğinden, doğru şekilde yapılandırıldığından ve besleme URL\'sinin erişilebilir olduğundan emin olun.</li><li><strong>Beslemede hiçbir yorum görünmüyor:</strong> Mağazanızda OpenCart\'ta onaylanmış ürün yorumları olduğundan emin olun.</li><li><strong>Opt-in veya Badge görünmüyor:</strong> İlgili entegrasyonun etkinleştirildiğini, Merchant ID\'nizin geçerli olduğunu ve kurulumdan sonra OpenCart modifikasyon önbelleğinin yenilendiğini doğrulayın.</li><li><strong>Opt-in veya Badge 404 hatası gösteriyor:</strong> Eklentinin, geçerli bir HTTPS sertifikasına sahip, herkese açık bir alana kurulu olduğundan emin olun. Google hizmetleri yerel, intranet veya güvenli olmayan alanlara erişemez.</li><li><strong>Besleme erişimi engellendi:</strong> Besleme koruması etkinleştirildiyse, besleme URL\'sine erişirken doğru kullanıcı adı ve şifrenin sağlandığından emin olun.</li></ul>';
