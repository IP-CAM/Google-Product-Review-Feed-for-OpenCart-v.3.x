...
$_['text_getting_started']       = '<p><strong>Обзор:</strong> Расширение Google Product Review Feed для OpenCart 3.x позволяет владельцам магазинов экспортировать и отправлять отзывы о товарах непосредственно в их Google Merchant Center. Эта интеграция позволяет Google отображать отзывы ваших клиентов рядом с вашими товарами в Google Shopping и других сервисах Google. Расширение также предлагает опциональные интеграции Opt-in и Badge, которые позволяют собирать отзывы после покупки с помощью опросов Google и отображать значок рейтинга продавца на витрине вашего магазина.</p><p><strong>Требования:</strong> OpenCart 3.x+, PHP 7.3 или выше, а также доступ к вашему <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> с включенной программой Product Ratings.</p>';
$_['text_setup']                 = '<p><strong>Установка и настройка:</strong></p><ul><li><strong>Шаг 1:</strong> Загрузите расширение с помощью установщика расширений OpenCart.</li><li><strong>Шаг 2:</strong> После установки перейдите в раздел <strong>Расширения</strong> -&gt; <strong>Модификации</strong> и нажмите кнопку <strong>Обновить</strong> для обновления кэша модификаций.</li><li><strong>Шаг 3:</strong> Перейдите в раздел <strong>Расширения</strong> -&gt; <strong>Каналы данных</strong>.</li><li><strong>Шаг 4:</strong> Найдите <strong>Playful Sparkle - Google Product Review Feed</strong> в списке и нажмите <strong>Редактировать</strong>.</li><li><strong>Шаг 5:</strong> Введите ваш <strong>Google Merchant Center ID</strong>.</li><li><strong>Шаг 6:</strong> Включите <strong>Opt-in Integration</strong>, чтобы разрешить Google показывать опрос после оформления заказа.</li><li><strong>Шаг 7:</strong> Включите <strong>Badge Integration</strong>, чтобы отображать значок Google Customer Reviews на вашем сайте.</li><li><strong>Шаг 8:</strong> Опционально установите <strong>имя пользователя</strong> и <strong>пароль</strong> для защиты доступа к URL-адресу канала отзывов.</li><li><strong>Шаг 9:</strong> Сохраните настройки.</li></ul>';
$_['text_troubleshot']           = '<ul><li><strong>Канал данных не отображается:</strong> Убедитесь, что расширение включено, правильно настроено, и URL-адрес канала данных доступен.</li><li><strong>Отзывы не отображаются в канале данных:</strong> Убедитесь, что в вашем магазине OpenCart есть одобренные отзывы о товарах.</li><li><strong>Opt-in или Badge не видны:</strong> Убедитесь, что соответствующая интеграция включена, ваш Merchant ID действителен, и кэш модификаций OpenCart был обновлен после установки.</li><li><strong>Opt-in или Badge показывают ошибку 404:</strong> Убедитесь, что расширение установлено на общедоступном домене с действительным сертификатом HTTPS. Сервисы Google не могут получить доступ к локальным сетям, интранет или незащищенным доменам.</li><li><strong>Доступ к каналу данных заблокирован:</strong> Если включена защита канала данных, убедитесь, что при доступе к URL-адресу канала данных предоставлены правильные имя пользователя и пароль.</li></ul>';
