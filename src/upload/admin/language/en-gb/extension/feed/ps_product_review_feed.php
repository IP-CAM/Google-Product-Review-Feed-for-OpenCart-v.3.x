...
$_['text_troubleshot']             = '<ul><li><strong>Feed not displaying:</strong> Ensure the extension is enabled and properly configured.</li><li><strong>No reviews appear in the feed:</strong> Your store must have approved product reviews in OpenCart.</li><li><strong>Opt-in or Badge not visible:</strong> Verify that the relevant integration is enabled and your Merchant ID is valid.</li><li><strong>Feed access blocked:</strong> If you enabled feed protection, make sure you provide the correct username and password when accessing the feed URL.</li></ul>';
