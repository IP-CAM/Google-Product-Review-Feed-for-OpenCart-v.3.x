...
$_['text_setup']                   = '<p><strong>Installation and Setup:</strong> Upload the extension using the OpenCart Extension Installer. Once uploaded, navigate to <em>Extensions → Feeds</em> and locate <strong>Playful Sparkle – Google Product Review Feed</strong> in the list. Click "Edit" to configure the extension: enter your Google Merchant Center ID, enable Opt-in Integration and/or Badge Integration as needed, and optionally set a username and password to restrict access to the review feed.</p>';
$_['text_troubleshot']             = '<ul>
    <li><strong>Feed not displaying:</strong> Ensure the extension is enabled and properly configured.</li>
    <li><strong>No reviews appear in the feed:</strong> Your store must have approved product reviews in OpenCart.</li>
    <li><strong>Opt-in or Badge not visible:</strong> Verify that the relevant integration is enabled and your Merchant ID is valid.</li>
    <li><strong>Feed access blocked:</strong> If you enabled feed protection, make sure you provide the correct username and password when accessing the feed URL.</li>
    </ul>';
$_['text_faq']                     = '<details><summary>Why is my feed empty?</summary>Make sure your products have approved customer reviews in OpenCart. Only reviews marked as "enabled" are included in the feed.</details>
    <details><summary>Where can I find my Merchant ID?</summary>You can find your Merchant Center ID in the top right corner of your Google Merchant Center account dashboard.</details>
    <details><summary>How do I test the feed URL?</summary>Visit the feed URL in your browser. If feed protection is enabled, use the configured username and password when prompted. You should see an XML file with your product reviews.</details>
        <details><summary>Do I need both Opt-in and Badge Integration?</summary>No, you can enable either or both based on your needs. The Opt-in feature enables post-purchase surveys, while the Badge displays your seller rating on the site.</details>';
