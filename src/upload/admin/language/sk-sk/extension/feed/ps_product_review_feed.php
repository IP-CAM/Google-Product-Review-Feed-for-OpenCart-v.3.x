...
$_['text_getting_started']         = '<p><strong>Prehľad:</strong> Rozšírenie Google Product Review Feed pre OpenCart 3.x umožňuje majiteľom obchodov exportovať a odosielať recenzie produktov priamo do ich Google Merchant Center. Táto integrácia umožňuje spoločnosti Google zobrazovať recenzie generované vašimi zákazníkmi spolu s vašimi produktmi v Google Shopping a ďalších Google services. Rozšírenie tiež ponúka voliteľné Opt-in a Badge integrácie, ktoré vám umožňujú zbierať spätnú väzbu po nákupe prostredníctvom Google surveys a zobrazovať odznak s hodnotením predajcu na vašom obchode.</p><p><strong>Požiadavky:</strong> OpenCart 3.x+, PHP 7.3 alebo vyšší a prístup k vášmu <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> so zapnutým Product Ratings program.</p>';
$_['text_setup']                   = '<p><strong>Inštalácia a nastavenie:</strong></p><ul><li><strong>Krok 1:</strong> Nahrajte rozšírenie pomocou inštalátora rozšírení OpenCart.</li><li><strong>Krok 2:</strong> Po inštalácii prejdite do sekcie <strong>Extensions</strong> -&gt; <strong>Modifications</strong> a kliknutím na tlačidlo <strong>Refresh</strong> aktualizujte vyrovnávaciu pamäť modifikácií.</li><li><strong>Krok 3:</strong> Prejdite do sekcie <strong>Extensions</strong> -&gt; <strong>Feeds</strong>.</li><li><strong>Krok 4:</strong> V zozname nájdite <strong>Playful Sparkle - Google Product Review Feed</strong> a kliknite na <strong>Edit</strong>.</li><li><strong>Krok 5:</strong> Zadajte svoje <strong>Google Merchant Center ID</strong>.</li><li><strong>Krok 6:</strong> Povoľte <strong>Opt-in Integration</strong>, aby spoločnosť Google mohla po dokončení objednávky zobraziť dotazník.</li><li><strong>Krok 7:</strong> Povoľte <strong>Badge Integration</strong> na zobrazenie odznaku Google Customer Reviews na vašej stránke.</li><li><strong>Krok 8:</strong> Voliteľne nastavte <strong>username</strong> a <strong>password</strong> na ochranu prístupu k URL adrese feedu recenzií.</li><li><strong>Krok 9:</strong> Uložte svoje nastavenia.</li></ul>';
$_['text_troubleshot']             = '<ul><li><strong>Feed sa nezobrazuje:</strong> Uistite sa, že je rozšírenie povolené, správne nakonfigurované a URL adresa feedu je prístupná.</li><li><strong>Vo feede sa nezobrazujú žiadne recenzie:</strong> Skontrolujte, či váš obchod má schválené recenzie produktov v OpenCart.</li><li><strong>Opt-in alebo Badge nie je viditeľný:</strong> Overte, či je príslušná integrácia povolená, vaše Merchant ID je platné a vyrovnávacia pamäť modifikácií OpenCart bola po inštalácii obnovená.</li><li><strong>Opt-in alebo Badge zobrazuje chybu 404:</strong> Uistite sa, že rozšírenie je nainštalované na verejne prístupnej doméne s platným certifikátom HTTPS. Google services nemôžu pristupovať k lokálnym, intranetovým alebo nezabezpečeným doménam.</li><li><strong>Prístup k feedu je zablokovaný:</strong> Ak je povolená ochrana feedu, uistite sa, že pri prístupe k URL adrese feedu zadávate správne užívateľské meno a heslo.</li></ul>';
