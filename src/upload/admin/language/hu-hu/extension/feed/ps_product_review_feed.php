...
$_['text_getting_started']         = '<p><strong>Áttekintés:</strong> A Google Product Review Feed bővítmény OpenCart 3.x rendszerekhez lehetővé teszi a bolt tulajdonosok számára, hogy termék véleményeket exportáljanak és közvetlenül elküldjenek Google Merchant Center fiókjukba. Ez az integráció lehetővé teszi a Google számára, hogy megjelenítse az ügyfelek által írt véleményeket a termékei mellett a Google Shopping-ban és más Google szolgáltatásokban. A bővítmény opcionális Opt-in és Badge integrációkat is kínál, amelyek lehetővé teszik a vásárlás utáni visszajelzések gyűjtését Google felméréseken keresztül, és a kereskedői értékelés jelvényének megjelenítését a webáruházban.</p><p><strong>Követelmények:</strong> OpenCart 3.x+ rendszer, PHP 7.3 vagy újabb verzió, és hozzáférés a <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> fiókjához bekapcsolt Termékértékelés programmal.</p>';
$_['text_setup']                   = '<p><strong>Telepítés és beállítás:</strong></p><ul><li><strong>1. lépés:</strong> Töltse fel a bővítményt az OpenCart Bővítmény Telepítő segítségével.</li><li><strong>2. lépés:</strong> A telepítés után menjen a <strong>Bővítmények</strong> -&gt; <strong>Módosítások</strong> menüpontra, és kattintson a <strong>Frissítés</strong> gombra a módosítási gyorsítótár frissítéséhez.</li><li><strong>3. lépés:</strong> Lépjen a <strong>Bővítmények</strong> -&gt; <strong>Adatfolyamok</strong> menüpontra.</li><li><strong>4. lépés:</strong> Keresse meg a <strong>Playful Sparkle - Google Product Review Feed</strong> tételt a listában, és kattintson a <strong>Szerkesztés</strong> gombra.</li><li><strong>5. lépés:</strong> Adja meg a <strong>Google Merchant Center ID</strong>-t.</li><li><strong>6. lépés:</strong> Engedélyezze az <strong>Opt-in Integration</strong>-t, hogy a Google felmérést jeleníthessen meg a fizetés után.</li><li><strong>7. lépés:</strong> Engedélyezze a <strong>Badge Integration</strong>-t a Google Customer Reviews jelvény megjelenítéséhez az oldalán.</li><li><strong>8. lépés:</strong> Opcionálisan adjon meg egy <strong>felhasználónevet</strong> és <strong>jelszót</strong> a vélemény adatfolyam URL hozzáférésének védelméhez.</li><li><strong>9. lépés:</strong> Mentse a beállításokat.</li></ul>';
$_['text_troubleshot']             = '<ul><li><strong>Az adatfolyam nem jelenik meg:</strong> Győződjön meg róla, hogy a bővítmény engedélyezve van, megfelelően konfigurálva van, és a feed URL hozzáférhető.</li><li><strong>Nincsenek vélemények az adatfolyamban:</strong> Ellenőrizze, hogy az áruházában vannak jóváhagyott termék vélemények az OpenCart rendszerben.</li><li><strong>Opt-in vagy Badge nem látható:</strong> Ellenőrizze, hogy a releváns integráció engedélyezve van, az Ön Merchant ID érvényes, és az OpenCart módosítási gyorsítótár frissítve lett a telepítés után.</li><li><strong>Az Opt-in vagy Badge 404 error-t mutat:</strong> Győződjön meg róla, hogy a bővítmény nyilvánosan hozzáférhető domain-en van telepítve érvényes HTTPS tanúsítvánnyal. A Google szolgáltatások nem férnek hozzá helyi, intranet vagy nem biztonságos domain-ekhez.</li><li><strong>Adatfolyam hozzáférés blokkolva:</strong> Ha az adatfolyam védelem engedélyezve van, győződjön meg róla, hogy a helyes felhasználónév és jelszó van megadva az adatfolyam URL elérésekor.</li></ul>';
