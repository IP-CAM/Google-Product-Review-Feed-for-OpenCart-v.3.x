...
$_['text_getting_started']         = '<p><strong>Aperçu:</strong> L\'extension Google Product Review Feed pour OpenCart 3.x permet aux propriétaires de magasins d\'exporter et de soumettre les avis sur les produits directement à leur Google Merchant Center. Cette intégration permet à Google d\'afficher les avis générés par vos clients à côté de vos produits dans Google Shopping et d\'autres services Google. L\'extension propose également des intégrations optionnelles d\'Opt-in et de Badge, qui vous permettent de recueillir les commentaires après l\'achat via des Google surveys et d\'afficher le badge de votre note vendeur sur votre boutique en ligne.</p><p><strong>Prérequis:</strong> OpenCart 3.x+, PHP 7.3 ou supérieur, et accès à votre <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> avec le programme Product Ratings activé.</p>';
$_['text_setup']                   = '<p><strong>Installation et Configuration:</strong></p><ul><li><strong>Étape 1:</strong> Téléchargez l\'extension en utilisant l\'installateur d\'extensions d\'OpenCart.</li><li><strong>Étape 2:</strong> Après l\'installation, allez dans <strong>Extensions</strong> -> <strong>Modifications</strong> et cliquez sur le bouton <strong>Rafraîchir</strong> pour mettre à jour le cache des modifications.</li><li><strong>Étape 3:</strong> Naviguez vers <strong>Extensions</strong> -> <strong>Flux</strong>.</li><li><strong>Étape 4:</strong> Localisez <strong>Playful Sparkle - Google Product Review Feed</strong> dans la liste et cliquez sur <strong>Modifier</strong>.</li><li><strong>Étape 5:</strong> Saisissez votre <strong>ID Google Merchant Center</strong>.</li><li><strong>Étape 6:</strong> Activez l\'<strong>Intégration Opt-in</strong> pour permettre à Google d\'afficher une enquête après le paiement.</li><li><strong>Étape 7:</strong> Activez l\'<strong>Intégration Badge</strong> pour afficher le badge Google Customer Reviews sur votre site.</li><li><strong>Étape 8:</strong> Optionnellement, définissez un <strong>nom d\'utilisateur</strong> et un <strong>mot de passe</strong> pour protéger l\'accès à l\'URL du flux d\'avis.</li><li><strong>Étape 9:</strong> Enregistrez vos paramètres.</li></ul>';
$_['text_troubleshot']             = '<ul><li><strong>Flux non affiché:</strong> Assurez-vous que l\'extension est activée, correctement configurée, et que l\'URL du flux est accessible.</li><li><strong>Aucun avis n\'apparaît dans le flux:</strong> Confirmez que votre magasin a des avis produits approuvés dans OpenCart.</li><li><strong>Opt-in ou Badge non visible:</strong> Vérifiez que l\'intégration concernée est activée, que votre ID Merchant est valide, et que le cache des modifications OpenCart a été rafraîchi après l\'installation.</li><li><strong>Opt-in ou Badge affiche une erreur 404:</strong> Assurez-vous que l\'extension est installée sur un domaine accessible publiquement avec un certificat HTTPS valide. Les services Google ne peuvent pas accéder aux domaines locaux, intranet ou non sécurisés.</li><li><strong>Accès au flux bloqué:</strong> Si la protection du flux est activée, assurez-vous que le nom d\'utilisateur et le mot de passe corrects sont fournis lors de l\'accès à l\'URL du flux.</li></ul>';
