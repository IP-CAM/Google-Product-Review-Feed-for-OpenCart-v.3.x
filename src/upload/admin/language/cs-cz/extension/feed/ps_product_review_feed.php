...
$_['text_getting_started']         = '<p><strong>Přehled:</strong> Rozšíření Google Product Review Feed pro OpenCart 3.x umožňuje majitelům obchodů exportovat a odesílat recenze produktů přímo do jejich Google Merchant Center. Tato integrace umožňuje Google zobrazovat recenze generované vašimi zákazníky vedle vašich produktů v Google Shopping a dalších službách Google. Rozšíření také nabízí volitelné integrace Opt-in a Badge, které vám umožňují sbírat zpětnou vazbu po nákupu prostřednictvím průzkumů Google a zobrazovat odznak hodnocení prodejce ve vašem obchodě.</p><p><strong>Požadavky:</strong> OpenCart 3.x+, PHP 7.3 nebo vyšší a přístup k vašemu <a href="https://merchants.google.com?hl=en" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> s povoleným programem hodnocení produktů.</p>';
$_['text_setup']                   = '<p><strong>Instalace a nastavení:</strong></p><ul><li><strong>Krok 1:</strong> Nahrajte rozšíření pomocí OpenCart Extension Installer.</li><li><strong>Krok 2:</strong> Po instalaci přejděte na <strong>Rozšíření</strong> -&gt; <strong>Úpravy</strong> a kliknutím na tlačítko <strong>Obnovit</strong> aktualizujte cache úprav.</li><li><strong>Krok 3:</strong> Přejděte na <strong>Rozšíření</strong> -&gt; <strong>Feedy</strong>.</li><li><strong>Krok 4:</strong> V seznamu najděte <strong>Playful Sparkle - Google Product Review Feed</strong> a klikněte na <strong>Upravit</strong>.</li><li><strong>Krok 5:</strong> Zadejte své <strong>ID obchodníka Google Merchant Center</strong>.</li><li><strong>Krok 6:</strong> Povolte <strong>Integraci Opt-in</strong>, abyste umožnili Google zobrazit průzkum po dokončení objednávky.</li><li><strong>Krok 7:</strong> Povolte <strong>Integraci Badge</strong> pro zobrazení odznaku Google Customer Reviews na vašem webu.</li><li><strong>Krok 8:</strong> Volitelně nastavte <strong>uživatelské jméno</strong> a <strong>heslo</strong> pro ochranu přístupu k URL feedu recenzí.</li><li><strong>Krok 9:</strong> Uložte nastavení.</li></ul>';
$_['text_troubleshot']             = '<ul><li><strong>Feed se nezobrazuje:</strong> Ujistěte se, že rozšíření je povoleno, správně nakonfigurováno a URL feedu je přístupné.</li><li><strong>Ve feedu se nezobrazují žádné recenze:</strong> Zkontrolujte, zda váš obchod má schválené recenze produktů v OpenCart.</li><li><strong>Opt-in nebo Badge nejsou viditelné:</strong> Ověřte, zda je příslušná integrace povolena, vaše ID obchodníka je platné a cache úprav OpenCart byla po instalaci obnovena.</li><li><strong>Opt-in nebo Badge zobrazuje chybu 404:</strong> Ujistěte se, že rozšíření je nainstalováno na veřejně přístupné doméně s platným HTTPS certifikátem. Služby Google nemají přístup k lokálním, intranetovým nebo nezabezpečeným doménám.</li><li><strong>Přístup k feedu je blokován:</strong> Pokud je povolena ochrana feedu, ujistěte se, že při přístupu k URL feedu zadáváte správné uživatelské jméno a heslo.</li></ul>';
